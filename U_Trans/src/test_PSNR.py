...
from utils import validation_PSNR, generate_filelist1
import os
...
parser.add_argument('-t', '--test-image-dir', help='test images path', default='./../data/NH-Haze/valid_NH/')
parser.add_argument('-c', '--ckpts-dir', help='ckpts path', default='./../ckpts/NH/NH-0904-1914/dehamer-epoch76-0.05579.pt')
...
if dataset_name == 'NH':
    val_data_dir = '../data/NH-Haze/MC-Net/false'
    ckpts_dir = '../ckpts/NH/NH-0904-1914/dehamer-epoch53-0.05601.pt'
...
if not os.path.exists(os.path.join(val_data_dir, 'val_list.txt')):
    generate_filelist1(val_data_dir)
...
val_data_loader = DataLoader(ValData(dataset_name,val_data_dir), batch_size=val_batch_size, shuffle=False, num_workers=6)

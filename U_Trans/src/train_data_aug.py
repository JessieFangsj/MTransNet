...
class TrainData(data.Dataset):
    def __init__(self,dataset_name, crop_size, train_data_dir):
        ...
        if not os.path.exists(os.path.join(train_data_dir, 'trainlist.txt')):
            generate_filelist(train_data_dir, valid=False)
    ...
    def get_images(self, index):
        ...
        if self.dataset_name=='NH' or self.dataset_name=='dense':
            ...
            clear = Image.open(self.train_data_dir + '/clear_images/' + gt_name )
